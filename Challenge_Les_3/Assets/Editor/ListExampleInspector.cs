...
public class listExampleInspector : Editor
{
    ...
    private void DrawElement(Rect rect, int index, bool active, bool focused)
    {
        ...
        item.someBool = EditorGUI.Toggle(new Rect(rect.x, rect.y, 18, rect.height), item.someBool);
        item.someFloat = EditorGUI.FloatField(new Rect(rect.x + 18, rect.y, rect.width - 18, rect.height), item.someFloat);
